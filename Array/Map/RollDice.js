/*
 * Write a program in the following step
   a. Roll a die and find the number b/w 1 to 6
   b. Repeat the die roll and the find the result  each time
   c. Store the result in a dictionary  Repeat till any one of the number  has reached  10 times
   d. Repeat till any one of the number  has reached  10 times
   e. Find the numder that reached maximum times and the  one that was for minimum times
